...
if ( ! class_exists( 'TNEIGHBORHOOD_Plugin_Activation' ) ) {
	 ...
	 * @author  Gary Jones
	 */
	class TNEIGHBORHOOD_Plugin_Activation {
		/**
		 ...
		 * @since 1.0.0
		 *
		 * @var TNEIGHBORHOOD_Plugin_Activation
		 */
		 ...
		 * @since 1.0.0
		 *
		 * @see TNEIGHBORHOOD_Plugin_Activation::init()
		 */
		 ...
		 * @since 2.0.0
		 *
		 * @see TNEIGHBORHOOD_Plugin_Activation::admin_menu()
		 * @see TNEIGHBORHOOD_Plugin_Activation::notices()
		 * @see TNEIGHBORHOOD_Plugin_Activation::styles()
		 */
		 ...
		 *
		 * @see TNEIGHBORHOOD_Plugin_Activation::init()
		 * @see TNEIGHBORHOOD_Plugin_Activation::install_plugins_page()
		 *
		 ...
		 * @since 2.4.0
		 *
		 * @return object The TNEIGHBORHOOD_Plugin_Activation object.
		 */
	...
	if ( ! function_exists( 'load_tNEIGHBORHOOD_plugin_activation' ) ) {
		/**
		 * Ensure only one instance of the class is ever invoked.
		 */
		function load_tNEIGHBORHOOD_plugin_activation() {
			$GLOBALS['tgmpa'] = TNEIGHBORHOOD_Plugin_Activation::get_instance();
		}
	}

	if ( did_action( 'plugins_loaded' ) ) {
		load_tNEIGHBORHOOD_plugin_activation();
	} else {
		add_action( 'plugins_loaded', 'load_tNEIGHBORHOOD_plugin_activation' );
	}
}
...
if ( ! class_exists( 'TGMPA_List_Table' ) ) {
	...
	class TGMPA_List_Table extends WP_List_Table {
		 ...
		 *
		 * @since      2.2.0
		 * @deprecated 2.5.0 use {@see TNEIGHBORHOOD_Plugin_Activation::_get_plugin_data_from_name()} instead.
		 * @see        TNEIGHBORHOOD_Plugin_Activation::_get_plugin_data_from_name()
		 *
		 * @param string $name Name of the plugin, as it was registered.
		 * @param string $data Optional. Array key of plugin data to return. Default is slug.
		 * @return string|boolean Plugin slug if found, false otherwise.
		...
		protected function _get_plugin_data_from_name( $name, $data = 'slug' ) {
			_deprecated_function( __FUNCTION__, 'TGMPA 2.5.0', 'TNEIGHBORHOOD_Plugin_Activation::_get_plugin_data_from_name()' );
...
if ( ! class_exists( 'TNEIGHBORHOOD_Bulk_Installer' ) ) {

	/**
	 * Hack: Prevent TGMPA v2.4.1- bulk installer class from being loaded if 2.4.1- is loaded after 2.5+.
	 */
	class TNEIGHBORHOOD_Bulk_Installer {
	}
}
if ( ! class_exists( 'TNEIGHBORHOOD_Bulk_Installer_Skin' ) ) {

	/**
	 * Hack: Prevent TGMPA v2.4.1- bulk installer skin class from being loaded if 2.4.1- is loaded after 2.5+.
	 */
	class TNEIGHBORHOOD_Bulk_Installer_Skin {
	}
}
	...
	function tgmpa_load_bulk_installer() {
		...
		if ( isset( $_GET['page'] ) && $tgmpa_instance->menu === $_GET['page'] ) {
			...
			if ( ! class_exists( 'TGMPA_Bulk_Installer' ) ) {
				 ...
				 * @internal Since 2.5.2 the class has been renamed from TNEIGHBORHOOD_Bulk_Installer to TGMPA_Bulk_Installer.
			...
			if ( ! class_exists( 'TGMPA_Bulk_Installer_Skin' ) ) {
				 ...
				 * @since 2.2.0
				 *
				 * @internal Since 2.5.2 the class has been renamed from TNEIGHBORHOOD_Bulk_Installer_Skin to
...
if ( ! class_exists( 'TGMPA_Utils' ) ) {
	 ...
	 *
	 * Class was called TNEIGHBORHOOD_Utils in 2.5.0 but renamed TGMPA_Utils in 2.5.1 as this was conflicting with Soliloquy.
	 *
	 * @since 2.5.0
	 *
	 * @package TGM-Plugin-Activation
