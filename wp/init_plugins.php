...
require_once 'activate_plugins/class-tgm-plugin-activation.php';
 ...
 * TNEIGHBORHOOD_Plugin_Activation class constructor.
 */
function neighborhood_register_required_plugins() {
	/*
	...
	$plugins = array(
		...
		array(
			...
			'source'             => get_stylesheet_directory() . '/_plugins/wp-migrate-db-pro.zip', // The plugin source.
			'required'           => true, // If false, the plugin is only 'recommended' instead of required.
			'force_activation'   => true, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
			'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins.
		...
		array(
			...
			'source'             => get_stylesheet_directory() . '/_plugins/wp-migrate-db-pro-media-files.zip', // The plugin source.
			'required'           => true, // If false, the plugin is only 'recommended' instead of required.
			'force_activation'   => true, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
			'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins.
			'external_url'       => '', // If set, overrides default API URL and points to an external URL.
		...
		array(
			'name'               => 'WP Migrate DB Pro CLI', // The plugin name.
			'slug'               => 'wp-migrate-db-pro-cli', // The plugin slug (typically the folder name).
			'source'             => get_stylesheet_directory() . '/_plugins/wp-migrate-db-pro-cli.zip', // The plugin source.
			'required'           => true, // If false, the plugin is only 'recommended' instead of required.
			'force_activation'   => true, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
			'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins.
			'external_url'       => '', // If set, overrides default API URL and points to an external URL.
...
add_action( 'tgmpa_register', 'neighborhood_register_required_plugins' );
